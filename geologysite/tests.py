...
class HomePageViewTest(TestCase):
    ...
    def test_homepage(self):
        ...
        """Checking that homepage return status code 200 and render correct templates"""
...
class MineralListViewTest(TestCase):
    ...
    def test_view_url_exist(self):
        ...
        """Checking that minerals database page return status code 200 and render correct templates"""
...
class MineralDetailViewTest(TestCase):
    ...
    def test_view_url_exist(self):
        """Checking that content page return status code 200 and render correct templates"""
...
class RockListViewTest(TestCase):
    ...
    def test_view_url_exist(self):
        ...
        """Checking that rocks database page return status code 200 and render correct templates"""
